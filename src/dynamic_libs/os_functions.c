...
EXPORT_DECL(int, MCP_GetSysProdSettings, u32 handle, MCPSysProdSettings *settings);

//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//! UC functions
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

EXPORT_DECL(int, UCReadSysConfig, unsigned int handle, unsigned int count, UCSysConfig *settings);
