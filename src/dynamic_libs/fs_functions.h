...
extern int (* FSReadFileAsync)(void *pClient, void *pCmd, uint8_t *buffer, uint32_t size, uint32_t count, int fd, uint32_t errHandling, uint32_t flag, const void *asyncData);
...
extern int (* FSReadFileWithPosAsync)(void *pClient, void *pCmd, void *buffer, int size, int count, int pos, int fd, int flag, int errHandling, const void *asyncData);
