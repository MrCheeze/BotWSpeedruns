...
extern int (* MCP_GetSysProdSettings)(u32 handle, MCPSysProdSettings *settings);

//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//! UC functions
//!----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
extern int (* UCReadSysConfig)(unsigned int handle, unsigned int count, UCSysConfig *settings);
