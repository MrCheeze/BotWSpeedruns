...
extern "C" 
{
	...
	typedef struct pygecko_bss_t pygecko_bss_t;
	...
	struct UCSysConfig
	{
		char name[32];
		u8 unk1[32];
		u32 unk2; // access rights? 0x777
		u32 dataType;
		u32 unk3; // usually 0x00?
		u32 dataSize;
		void *data;
	};
	#pragma pack(pop)
	static_assert(sizeof(UCSysConfig) == 0x54, "UCSysConfig Size");
	...
	#pragma pack(pop)
	static_assert(sizeof(MCPSysProdSettings) == 0x46, "MCPSysProdSettings Size");
